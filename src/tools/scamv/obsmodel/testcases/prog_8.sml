(* ========================= prog_8 - program with function call =========================== *)
...
val prog_8_mem_address_pc = ``
F
``;

val prog_8_mem_address_pc_lspc = ``
F
``;

val prog_8_cache_tag_index = ``
F
``;

val prog_8_cache_tag_only = ``
F
``;

val prog_8_cache_index_only = ``
F
``;

val prog_8_cache_tag_index_part = ``
F
``;

val prog_8_cache_tag_index_part_page = ``
F
``;

val prog_8_cache_speculation = ``
BirProgram
...
val prog_8_cache_speculation_first = ``
F
``;

val prog_8_test =
  ("prog_8 - program with function call", prog_8,
     (prog_8_mem_address_pc,
      prog_8_mem_address_pc_lspc,
      prog_8_cache_tag_index,
      prog_8_cache_tag_only,
      prog_8_cache_index_only,
      prog_8_cache_tag_index_part,
      prog_8_cache_tag_index_part_page,
      prog_8_cache_speculation,
      prog_8_cache_speculation_first)
  );
