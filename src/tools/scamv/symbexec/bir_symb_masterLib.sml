...
fun symb_exec_process_to_leafs_pdecide pdecide maxdepth precond prog =
  symb_exec_leaflist (symb_exec_program maxdepth precond prog pdecide);

val symb_exec_process_to_leafs_nosmt =
  symb_exec_process_to_leafs_pdecide (fn _ => true);

val symb_exec_process_to_leafs =
  symb_exec_process_to_leafs_pdecide pdecide;
