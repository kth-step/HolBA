signature bir_conc_execLib = sig
  ...
  val conc_exec_obs_compute : term -> modelValues list -> term list * modelValues list
  val conc_exec_obs_compare : term -> modelValues list * modelValues list -> bool * modelValues list list
end
