...
val bprog = List.nth((snd o strip_comb o concl) bin_small_example_thm, 3);
(*
...
*)
val birs_stop_lbls = [(snd o dest_eq o concl o EVAL) ``bir_block_pc (BL_Address (Imm32 0xb0cw))``];
