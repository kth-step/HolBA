...
,("<Bool R3_1_8 %s R0_0_8 == 0#8>",
   ``BExp_BinPred BIExp_Equal
  (BExp_BinExp BIExp_SignedMod (BExp_Den (BVar "R3" (BType_Imm Bit8)))
     (BExp_Den (BVar "R0" (BType_Imm Bit8)))) (BExp_Const (Imm8 0w))``, false)
...
,("<Bool (if R7_10_64 - (R0_4_64 << 0x1d#64) <s 0x0#64 then 1#1 else 0#1) != (if R0_4_64 << 0x1d#64 <=s R7_10_64 then 1#1 else 0#1)>",
 ...
 ,("<Bool ((if ((R1_5_64)[31:0]) >=s (0x0#32) then 0x1#1 else 0x0#1) & (~(if ((R1_5_64)[31:0]) == (0x0#32) then 0x1#1 else 0x0#1))) != (0x0#1)>",
   ``BExp_BinPred BIExp_NotEqual
  (BExp_BinExp BIExp_And
     (BExp_IfThenElse
        (BExp_BinPred BIExp_SignedLessOrEqual (BExp_Const (Imm32 0w))
           (BExp_CastMask Bit64 31 0 (BExp_Den (BVar "R1" (BType_Imm Bit64)))
              (THE (bir_immtype_of_size 32)))) (BExp_Const (Imm1 1w))
        (BExp_Const (Imm1 0w)))
     (BExp_UnaryExp BIExp_Not
        (BExp_IfThenElse
           (BExp_BinPred BIExp_Equal
           ...
           (BExp_Const (Imm1 1w)) (BExp_Const (Imm1 0w)))))
  (BExp_Const (Imm1 0w))``, true)

,("<Bool (((R1_5_64)[31:0]) >s (0x0#32)) != ((R9_5_32) <s (R8_5_32))>",
   ``BExp_BinPred BIExp_NotEqual
  (BExp_BinPred BIExp_SignedLessThan (BExp_Const (Imm32 0w))
     (BExp_CastMask Bit64 31 0 (BExp_Den (BVar "R1" (BType_Imm Bit64)))
        (THE (bir_immtype_of_size 32))))
  (BExp_BinPred BIExp_SignedLessThan (BExp_Den (BVar "R9" (BType_Imm Bit32)))
     (BExp_Den (BVar "R8" (BType_Imm Bit32))))``, true)
