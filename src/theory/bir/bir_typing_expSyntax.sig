...
sig
   ...
   val bir_var_set_is_well_typed_tm   : term
   val dest_bir_var_set_is_well_typed : term -> term
   val is_bir_var_set_is_well_typed   : term -> bool
   val mk_bir_var_set_is_well_typed   : term -> term
