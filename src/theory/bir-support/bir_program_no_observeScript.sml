...
Definition bir_stmtB_is_observe_def:
  (bir_stmtB_is_observe (BStmt_Observe _ _ _ _) = T) /\
  (bir_stmtB_is_observe _ = F)
End

Theorem bir_stmtB_is_observe_ALT_DEF:
...
Theorem bir_exec_stmtB_only_observe_produces_observation:
...
Theorem bir_exec_stmt_only_observe_produces_observation:
...
Theorem bir_exec_stmtB_NO_OBSERVE:
...
Theorem bir_exec_stmt_NO_OBSERVE:
...
Theorem bir_exec_step_NO_OBSERVE_current:
...
Theorem bir_exec_step_NO_OBSERVE:
...
Theorem bir_exec_steps_observe_llist_NO_OBSERVE:
...
Theorem bir_exec_steps_observe_list_NO_OBSERVE:
  !p st step_no. (~(bir_program_contains_observe p)) ==>
...
Theorem bir_exec_steps_GEN_NO_OBSERVE:
...
Theorem bir_exec_steps_NO_OBSERVE:
  !p st. (~(bir_program_contains_observe p)) ==>
...
Theorem bir_exec_to_labels_n_NO_OBSERVE:
...
Theorem bir_exec_step_n_NO_OBSERVE:
  !p st step_no. (~(bir_program_contains_observe p)) ==>
...
Theorem bir_exec_block_n_NO_OBSERVE:
  !p st step_no. (~(bir_program_contains_observe p)) ==>
...
Definition bir_exec_stmtsB_state_def:
  bir_exec_stmtsB_state stmts (c, st) =
  SND (bir_exec_stmtsB stmts ([], c, st))
End


Theorem bir_exec_stmtsB_state_THM:
...
Theorem bir_exec_stmtsB_state_REWRS:
...
Theorem bir_exec_stmtsB_state_REWRS_COND:
  (!c st. (bir_exec_stmtsB_state [] (c, st) = (c, st))) /\
...
Definition bir_exec_block_state_def:
  bir_exec_block_state p bl st =
  SND (bir_exec_block p bl st)
End


Theorem bir_exec_stmtsB_NO_OBSERVE_THM:
...
Theorem bir_exec_block_state_ALT_DEF:
...
Theorem bir_exec_block_NO_OBSERVE_THM:
...
Theorem bir_exec_block_DEF_NO_OBSERVE:
  !p bl st. ~(bir_block_contains_observe bl) ==>
