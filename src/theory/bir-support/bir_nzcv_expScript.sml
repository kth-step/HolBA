...
Definition awc_BIR_C_def:
  awc_BIR_C w1 w2 c = FST (SND (add_with_carry (w1, w2, c)))
End
Definition awc_BIR_V_def:
  awc_BIR_V w1 w2 c = SND (SND (add_with_carry (w1, w2, c)))
End
Definition awc_BIR_N_def:
  awc_BIR_N w1 w2 c = (w1 + w2 + (if c then 1w else 0w) < 0w)
End
Definition awc_BIR_Z_def:
  awc_BIR_Z w1 w2 c = (w1 + w2 + (if c then 1w else 0w) = 0w)
End


(* Let's instroduce constants for the components of the nzcv tuple. Later we show that
   these correspond to simple subtraction. *)
Definition nzcv_BIR_SUB_N_def:
  nzcv_BIR_SUB_N w1 w2 = (let (n, z, c, v) = nzcv w1 w2 in n)
End
Definition nzcv_BIR_SUB_Z_def:
  nzcv_BIR_SUB_Z w1 w2 = (let (n, z, c, v) = nzcv w1 w2 in z)
End
Definition nzcv_BIR_SUB_C_def:
  nzcv_BIR_SUB_C w1 w2 = (let (n, z, c, v) = nzcv w1 w2 in c)
End
Definition nzcv_BIR_SUB_V_def:
  nzcv_BIR_SUB_V w1 w2 = (let (n, z, c, v) = nzcv w1 w2 in v)
End

Theorem nzcv_BIR_SUB_DEF:
...
Definition nzcv_BIR_ADD_V_def:
  nzcv_BIR_ADD_V (w1 : 'a word) (w2 : 'a word) <=>
   ((word_msb w1 <=> word_msb w2) /\
    (word_msb (w1 + w2) <=/=> word_msb w1))
End

Definition nzcv_BIR_ADD_C_def:
  nzcv_BIR_ADD_C (w1 : 'a word) (w2 : 'a word) <=>
   BIT (dimindex (:'a)) (w2n w1 + w2n w2)
End

Definition nzcv_BIR_ADD_Z_def:
  nzcv_BIR_ADD_Z (w1 : 'a word) (w2 : 'a word) <=>
   nzcv_BIR_SUB_Z w1 (-w2)
End

Definition nzcv_BIR_ADD_N_def:
  nzcv_BIR_ADD_N (w1 : 'a word) (w2 : 'a word) <=>
...
Theorem nzcv_BIR_SUB_N_CARRY_DEF:
...
Theorem nzcv_BIR_SUB_Z_CARRY_DEF:
...
Theorem nzcv_BIR_SUB_C_CARRY_DEF:
...
Theorem nzcv_BIR_SUB_V_CARRY_DEF:
...
Theorem nzcv_BIR_ADD_N_CARRY_DEF:
...
Theorem nzcv_BIR_ADD_Z_CARRY_DEF:
...
Theorem nzcv_BIR_ADD_C_CARRY_DEF:
...
Theorem nzcv_BIR_ADD_V_CARRY_DEF:
...
Theorem nzcv_BIR_SUB_NZCV_REWRS:
...
Theorem nzcv_BIR_ADD_NZCV_REWRS:
...
Theorem awc_BIR_NZVC_ELIMS_SYM:
...
Theorem nzcv_BIR_SUB_Z_ID:
  !w. nzcv_BIR_SUB_Z w w = T
Proof
SIMP_TAC arith_ss [nzcv_BIR_SUB_NZCV_REWRS]
QED

Theorem nzcv_BIR_SUB_N_ID:
...
Definition nzcv_SUB_COND_CODE_EQ_def:
  nzcv_SUB_COND_CODE_EQ    w1 w2 <=> nzcv_BIR_SUB_Z w1 w2
End
Definition nzcv_SUB_COND_CODE_NE_def:
  nzcv_SUB_COND_CODE_NE    w1 w2 <=> ~(nzcv_BIR_SUB_Z w1 w2)
End
Definition nzcv_SUB_COND_CODE_CS_HS_def:
  nzcv_SUB_COND_CODE_CS_HS w1 w2 <=> nzcv_BIR_SUB_C w1 w2
End
Definition nzcv_SUB_COND_CODE_CC_LO_def:
  nzcv_SUB_COND_CODE_CC_LO w1 w2 <=> ~(nzcv_BIR_SUB_C w1 w2)
End
Definition nzcv_SUB_COND_CODE_MI_def:
  nzcv_SUB_COND_CODE_MI    w1 w2 <=> (nzcv_BIR_SUB_N w1 w2)
End
Definition nzcv_SUB_COND_CODE_PL_def:
  nzcv_SUB_COND_CODE_PL    w1 w2 <=> ~(nzcv_BIR_SUB_N w1 w2)
End
Definition nzcv_SUB_COND_CODE_VS_def:
  nzcv_SUB_COND_CODE_VS    w1 w2 <=> (nzcv_BIR_SUB_V w1 w2)
End
Definition nzcv_SUB_COND_CODE_VC_def:
  nzcv_SUB_COND_CODE_VC    w1 w2 <=> ~(nzcv_BIR_SUB_V w1 w2)
End
Definition nzcv_SUB_COND_CODE_HI_def:
  nzcv_SUB_COND_CODE_HI    w1 w2 <=> (nzcv_BIR_SUB_C w1 w2) /\ ~(nzcv_BIR_SUB_Z w1 w2)
End
Definition nzcv_SUB_COND_CODE_LS_def:
  nzcv_SUB_COND_CODE_LS    w1 w2 <=> ~(nzcv_BIR_SUB_C w1 w2) \/ (nzcv_BIR_SUB_Z w1 w2)
End
Definition nzcv_SUB_COND_CODE_GE_def:
  nzcv_SUB_COND_CODE_GE    w1 w2 <=> (nzcv_BIR_SUB_N w1 w2 <=> nzcv_BIR_SUB_V w1 w2)
End
Definition nzcv_SUB_COND_CODE_LT_def:
  nzcv_SUB_COND_CODE_LT    w1 w2 <=> ~(nzcv_BIR_SUB_N w1 w2 <=> nzcv_BIR_SUB_V w1 w2)
End
Definition nzcv_SUB_COND_CODE_GT_def:
  nzcv_SUB_COND_CODE_GT    w1 w2 <=> (((nzcv_BIR_SUB_N w1 w2 <=> nzcv_BIR_SUB_V w1 w2)) /\ ~(nzcv_BIR_SUB_Z w1 w2))
End

Definition nzcv_SUB_COND_CODE_LE_def:
  nzcv_SUB_COND_CODE_LE    w1 w2 <=> (~((nzcv_BIR_SUB_N w1 w2 <=> nzcv_BIR_SUB_V w1 w2)) \/ (nzcv_BIR_SUB_Z w1 w2))
End

Definition nzcv_SUB_COND_CODE_AL_def:
  nzcv_SUB_COND_CODE_AL    (w1 : 'a word) (w2:'a word) <=> T
End



Theorem nzcv_SUB_COND_CODE_EVALS:
...
Definition BExp_nzcv_SUB_N_def:
  BExp_nzcv_SUB_N sz e1 e2 =
   BExp_BinPred BIExp_SignedLessThan (BExp_BinExp BIExp_Minus e1 e2)
        (BExp_Const (n2bs 0 sz))
End

Definition BExp_nzcv_SUB_Z_def:
  BExp_nzcv_SUB_Z e1 e2 =
   BExp_BinPred BIExp_Equal e1 e2
End

Definition BExp_nzcv_SUB_C_def:
  BExp_nzcv_SUB_C e1 e2 =
   BExp_BinPred BIExp_LessOrEqual e2 e1
End

Definition BExp_nzcv_SUB_V_def:
  BExp_nzcv_SUB_V sz e1 e2 =
...
(* We can now define expressions for the nzcv flags *)
Definition BExp_nzcv_ADD_N_def:
  BExp_nzcv_ADD_N sz e1 e2 =
   BExp_BinPred BIExp_SignedLessThan (BExp_BinExp BIExp_Plus e1 e2)
        (BExp_Const (n2bs 0 sz))
End

Definition BExp_nzcv_ADD_Z_def:
  BExp_nzcv_ADD_Z e1 e2 =
   BExp_BinPred BIExp_Equal e1 (BExp_UnaryExp BIExp_ChangeSign e2)
End


Definition BExp_nzcv_ADD_C_def:
  BExp_nzcv_ADD_C e1 e2 =
   BExp_BinPred BIExp_LessThan (BExp_UnaryExp BIExp_Not e2) e1
End

Definition BExp_nzcv_ADD_V_def:
  BExp_nzcv_ADD_V sz e1 e2 =
...
(* We can now define expressions for the nzcv flags *)
Definition BExp_ADD_WITH_CARRY_N_def:
  BExp_ADD_WITH_CARRY_N sz e1 e2 ec =
...
Definition BExp_ADD_WITH_CARRY_Z_def:
  BExp_ADD_WITH_CARRY_Z sz e1 e2 ec =
...
Definition BExp_ADD_WITH_CARRY_C_def:
  BExp_ADD_WITH_CARRY_C e1 e2 ec =
   BExp_IfThenElse ec
...
Definition BExp_ADD_WITH_CARRY_V_def:
  BExp_ADD_WITH_CARRY_V sz e1 e2 ec =
     (BExp_BinExp BIExp_And
        (BExp_BinPred BIExp_Equal
           (BExp_BinPred BIExp_SignedLessThan e1
              (BExp_Const (n2bs 0 sz)))
...
Theorem BExp_ADD_WITH_CARRY_vars_of:
...
Theorem BExp_ADD_WITH_CARRY_N_eval:
  !sz e1 e2 ec env.
...
Theorem BExp_ADD_WITH_CARRY_V_eval:
  !sz e1 e2 ec env.
...
Theorem BExp_ADD_WITH_CARRY_Z_eval:
  !sz e1 e2 ec env.
...
Theorem BExp_ADD_WITH_CARRY_C_eval:
  !e1 e2 ec env.
