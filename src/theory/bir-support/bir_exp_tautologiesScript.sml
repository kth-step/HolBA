...
Definition bir_exp_is_taut_def:
  bir_exp_is_taut e <=> (
...
Definition bir_exp_is_satisfiable_def:
...
Theorem bir_exp_satisfiable_taut_NEGATION:
...
Theorem bir_exp_is_taut_WEAK_CONG_IMPL:
...
Theorem bir_exp_is_satisfiable_WEAK_CONG_IMPL:
...
Theorem bir_exp_is_satisfiable_WEAK_CONG_IFF:
...
Theorem bir_exp_is_satisfiable_CONG_IFF:
  !e1 e2. bir_exp_CONG e1 e2 ==>
        (bir_exp_is_satisfiable e1 <=> bir_exp_is_satisfiable e2)
Proof
FULL_SIMP_TAC (std_ss++boolSimps.EQUIV_EXTRACT_ss) [
...
Theorem bir_exp_is_taut_INTRODUCE_FRESH_VAR_AS_ABBREV:
...
Theorem bir_exp_is_taut_same_vars_both_bool:
  !ex ex' st.
