...
val simple_arith_prog_def = bdefprog_list "simple_arith_prog" [
...
(* Print it *)
val _ = print "simple_arith_prog_def:\n";
val _ = Hol_pp.print_thm simple_arith_prog_def;
val _ = print "\n";

(* Compare against the same hand-written BIR program *)
val simple_arith_prog_tm = (snd o dest_eq o concl) simple_arith_prog_def;
val is_correct = (simple_arith_prog_tm = ``
  BirProgram [
