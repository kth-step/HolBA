...
val prog_tm = ((rhs o concl) modexp_asmLib.prog_def);
...
val n_dict_2 = cfg_update_nodes_call lbl_tms n_dict_1;
val n_dict = n_dict_2;

val entries = [``BL_Address (Imm32 (0x100002f0w))``]; (* _my_modexp_asm *)
val entries = [``BL_Address (Imm32 (0x10000240w))``]; (* _my_uidivmod_mod_asm *)
