...
val symb_exec_thm = prove(``birs_symb_exec ^((lhs o concl) balrobLib.bir_balrob_prog_def)
          (<|bsst_pc :=
           ...
           {<|bsst_pc :=
              ...
              bsst_environ :=
                birs_gen_env
                  [("tmp_PSR_C",BExp_Den (BVar "syf_1251" (BType_Imm Bit1)));
                   ("ModeHandler",
                    BExp_Den (BVar "sy_ModeHandler" (BType_Imm Bit1)));
                   ("tmp_PC",BExp_Den (BVar "sy_tmp_PC" (BType_Imm Bit32)));
                   ("R12",BExp_Den (BVar "sy_R12" (BType_Imm Bit32)));
                   ("LR",BExp_Den (BVar "syf_1250" (BType_Imm Bit32)));
                   ("tmp_SP_process",
                   ...
                   ("R7",BExp_Den (BVar "syf_1249" (BType_Imm Bit32)));
                   ("R6",BExp_Den (BVar "syf_1248" (BType_Imm Bit32)));
                   ("R1",BExp_Den (BVar "syf_1247" (BType_Imm Bit32)));
                   ("PSR_V",BExp_Den (BVar "syf_1246" (BType_Imm Bit1)));
                   ("PSR_C",BExp_Den (BVar "syf_1245" (BType_Imm Bit1)));
                   ("PSR_N",BExp_Den (BVar "syf_1244" (BType_Imm Bit1)));
                   ("PSR_Z",BExp_Den (BVar "syf_1243" (BType_Imm Bit1)));
                   ("R0",BExp_Den (BVar "syf_1242" (BType_Imm Bit32)));
