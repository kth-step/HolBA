...
Theorem storeload_bsysprecond_thm =
 (computeLib.RESTR_EVAL_CONV [``birs_eval_exp``] THENC birs_stepLib.birs_eval_exp_CONV)
 ``mk_bsysprecond (bspec_storeload_pre pre_x2) storeload_birenvtyl``;

(* ----------------------- *)
(* Symbolic analysis setup *)
(* ----------------------- *)

val bprog_tm = (snd o dest_eq o concl) bir_storeload_prog_def;
val init_addr_tm = (snd o dest_eq o concl) storeload_init_addr_def;
val end_addr_tm = (snd o dest_eq o concl) storeload_end_addr_def;
...
val bprog_envtyl = (fst o dest_eq o concl) storeload_birenvtyl_def;

val birs_pcond = (snd o dest_eq o concl) storeload_bsysprecond_thm;
...
Theorem storeload_symb_analysis_thm = result
