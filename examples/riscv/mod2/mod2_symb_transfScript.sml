...
val bspec_pre_tm = (lhs o snd o strip_forall o concl) bspec_mod2_pre_def;
val bspec_post_tm = (lhs o snd o strip_forall o concl) bspec_mod2_post_def;
...
val bspec_cont_thm =
 bir_symb_transfer init_addr_tm end_addr_tm bspec_pre_tm bspec_post_tm
  ...
  bspec_mod2_pre_def bspec_mod2_post_def mod2_prog_vars_def
