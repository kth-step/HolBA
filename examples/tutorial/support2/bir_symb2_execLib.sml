structure bir_symb2_execLib :> bir_symb2_execLib = 
struct

local
(* 
app load ["bir_symb2_execTheory", "bir_symb2_envTheory", "bir_symb2_init_envLib"];
*)

open HolKernel
open pairLib
open bir_symb2_execTheory;
open bir_symb2_envTheory;
