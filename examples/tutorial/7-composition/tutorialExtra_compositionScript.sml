...
fun try_disch_all_assmpt_w_EVAL t =
  let
    val t_d      = DISCH_ALL t;
  ...
  in
    try_disch_all_assmpt_w_EVAL t2
  end
  handle HOL_ERR _ => t;

(* TODO: Replace by using pre str/post weak instead? *)
(* TODO: Really needed when we have def_list? *)
fun replace_def ct ex1 ex2 =
  REWRITE_RULE [(EVAL THENC
                  (REWRITE_CONV [GSYM (EVAL ex2)])
                ) ex1]
               ct;
