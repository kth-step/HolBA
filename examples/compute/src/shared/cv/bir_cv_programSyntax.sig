...
sig
  ...
  val cv_block_tm : term;
  val cv_program_tm : term;
  val cv_programcounter_tm : term;
  val cv_state_tm : term;
  ...
  val mk_cv_programcounter: (term * term) -> term;
  ...
  val dest_cv_programcounter : term -> (term * term);
  ...
  val is_cv_programcounter : term -> bool;
